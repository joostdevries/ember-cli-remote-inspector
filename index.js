...
module.exports = {
  ...
  serverMiddleware: function(config) {
    ...
    var port = process.env.EMBER_CLI_REMOTE_DEBUG_PORT = appConfig.remoteDebugPort,
      ...
      scheme = process.env.EMBER_CLI_REMOTE_DEBUG_SCHEME = appConfig.remoteDebugScheme;
    ...
    app.use(function(req, res, next) {
      ...
      if(cspHeader) {
        ...
        cspHeaderValue = cspHeaderValue.replace('connect-src \'self\' ', 'connect-src \'self\' '+scheme+'://'+host+':'+port+' ws://'+host+':'+port+' ')
        cspHeaderValue = cspHeaderValue.replace('script-src \'self\' ', 'script-src \'self\' \'unsafe-inline\' '+scheme+'://'+host+':'+port+' ')
