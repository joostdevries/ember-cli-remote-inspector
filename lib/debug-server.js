...
var inspectorPackagePath = path.dirname(require.resolve('ember-inspector/package.json'));
var inspectorPath = path.resolve(inspectorPackagePath, 'dist', 'websocket');
...
var inspectorHtml = fs.readFileSync(path.resolve(inspectorPath, 'index.html')).toString();
